<?php
/**
 * AutoWhats API - Alias / Puente para Verificación de Licencia
 * Permite acceder al validador desde /admin/check-license.php o /api/check-license.php
 */

if (file_exists(__DIR__ . '/../api/check-license.php')) {
    require_once __DIR__ . '/../api/check-license.php';
} else {
    // Si la carpeta /api/ no fue subida, ejecutar la lógica directamente aquí
